...
@property (nonatomic) BOOL needUploadAllTimeData;
/// 游戏标识，多端统一用
...
+ (void)tapTokenLoginWithKid:(NSString * _Nonnull)kid mackey:(NSString * _Nonnull)mackey clientID:(NSString * _Nonnull)clientID successHandler:(void (^ _Nullable)(NSString * _Nonnull, NSString * _Nonnull, NSString * _Nonnull))successHandler failureHandler:(void (^ _Nullable)(NSString * _Nonnull))failureHandler;
/// 登录用户
...
///
+ (void)realNameAuthWithClientId:(NSString * _Nonnull)clientId userId:(NSString * _Nonnull)userId code:(NSString * _Nonnull)code name:(NSString * _Nonnull)name idCard:(NSString * _Nonnull)idCard completion:(void (^ _Nonnull)(enum AntiAddictionRealNameAuthState, NSString * _Nonnull, enum AntiAddictionRealNameAgeLimit))completion;
/// 检查实名状态
/// \param userToken 用户唯一标识，如用户 ID
///
/// \param completion 结果回调
...
typedef SWIFT_ENUM(NSInteger, AntiAddictionServiceResult, open) {
  ...
  AntiAddictionServiceResultTimeLimit = 1030,
